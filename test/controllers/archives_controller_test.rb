...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post archives_url, params: { archive: { arch: @archive.arch, category_id: @archive.category_id, description: @archive.description, name: @archive.name } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { arch: @archive.arch, category_id: @archive.category_id, description: @archive.description, name: @archive.name } }
